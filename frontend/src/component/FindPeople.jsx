...
const FindPeople = () => {
    ...
    return (
        <>
            <div className="right col-lg-4 d-lg-block d-sm-none d-none rounded border-info border_radius d-flex flex-column p-3 mt-3 white mt-5">
                <div>
                ...
                <div className="max_height overflow-auto">
                    {values.users.map((user2, idx) => {
                        return (
                            <div key={`${user2._id}-${idx}`} className="d-flex align-items-center p-2 mb-3">
                                <div>
                                    <img
